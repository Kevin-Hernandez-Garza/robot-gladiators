...
var fight = function (enemyName) {
    ...
    while (playerHealth > 0 && enemyHealth > 0) {
        ...
        //ensures that the playerHealth value will stop at 0.
...
var startGame = function () {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        ...
        if (playerHealth > 0) {
            ...
            // will give us a random number, and round to the nearest whole number this will give a random number between min (40) and max (60) 
...
var shop = function () {
    ...
    var shopOptionPrompt = prompt("Would you like to REFILL you health, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice.");
